...
<div align="center">
  <h3>👋 Hi, I'm SSol! 👋</h3>
  <p>
    <strong>📌 Computer Vision, Sensor Fusion, and AI Developer🔧 </strong> 
  </p>
...
<table>
  <tr>
    ...
    <td align="left" valign="top">
      <strong> 🛠 Research and Development Areas </strong> <br><br>
      <ul>
        <li>📌 Image Restoration</li>
        <li>📌 Surround View System</li>
        <li>📌 Camera-LiDAR Sensor Fusion for 3D Object Detection</li>
        <li>📌 Camera-LiDAR-IMU Calibration</li>
        <li>📌 Real-Time Video Enhancement with GStreamer</li>
      </ul>
    </td>
    <!-- 오른쪽 섹션 -->
    <td align="left" valign="top">
...
<img src="https://github.com/ssolchoi/ssolchoi/blob/output/github-snake.svg" width="100%">
